package com.unicom.edgenodech.util;
...
public class JDBCUtils {
    ...
    public void insertAllByList(String tableName, List<Map<String, Object>> dataList, List<String> cols)
        throws Exception {
        ...
        try {
            connection = dataSourceClickHouse.getConnection();
    ...
    public Map<String, Object> queryCacheData(String sql, String limit, List<Object> param) throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        Connection conn = null;
        PreparedStatement preparedStatement = null;
        ResultSet rs = null;
        try {
            conn = dataSourceClickHouse.getConnection();
