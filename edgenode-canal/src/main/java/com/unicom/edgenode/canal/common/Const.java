package com.unicom.edgenode.canal.common;
...
public class Const {
    ...
    /**
     * 中国联通号码格式验证 手机段：130,131,132,155,156,185,186,145,146,166,167,171,175,176,1704、1707、1708、1709
     **/
    public static final String CHINA_UNICOM_PATTERN_NEW = "(^1(3[0-2]|4[56]|5[56]|6[67]|7[1]|7[56]|8[56])\\d{8}$)|(^1704\\d{7}$)|(^1707\\d{7}$)|(^1708\\d{7}$)|(^1709\\d{7}$)";
