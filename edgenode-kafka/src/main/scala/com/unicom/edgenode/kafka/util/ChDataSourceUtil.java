 ...
 * 德鲁伊连接池
 */
public class ChDataSourceUtil implements Serializable {
    public static DataSource dataSource = null;

    static {
        try {
            Properties props = new Properties();
            props.setProperty("url", ConfigurationManager.getProperty("ch.url"));
            props.setProperty("username", ConfigurationManager.getProperty("ch.username"));
            props.setProperty("password", ConfigurationManager.getProperty("ch.password"));
            ...
            props.setProperty("driverClassName", "ru.yandex.clickhouse.ClickHouseDriver");
