...
public class DataSourceUtil implements Serializable {
    ...
    static {
        try {
            ...
            props.setProperty("url", com.unicom.edgenode.kafka.util.ConfigurationManager.getProperty("jdbc.url"));
            props.setProperty("username", com.unicom.edgenode.kafka.util.ConfigurationManager.getProperty("jdbc.user"));
            props.setProperty("password", com.unicom.edgenode.kafka.util.ConfigurationManager.getProperty("jdbc.password"));
